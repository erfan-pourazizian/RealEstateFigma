  ...
  return (
    <div className='flex bg-sp-orange2 mt-24 sm:mt-40 mb-24 sm:mb-40 mx-[5%] px-[4%] sm:px-[6%] py-4 sm:py-10 rounded-[10px] items-center' id="connect">
      <div className="sm:grow">
        <h1 className='text-base sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-spSize1 text-white font-bold w-full sm:w-[75%] md:w-[59%]'>Get Connected with top agents near you and find your home</h1>
