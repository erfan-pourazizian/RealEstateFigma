...
const Connect = () => {
  return (
    <div className='relative flex bg-sp-orange2 mt-16 sm:mt-40 mb-16 sm:mb-40 mx-[5%] px-[4%] sm:px-[6%] py-4 sm:py-10 rounded-[10px] items-center' id="connect">
      ...
      <Link href="/search">
        <button className="text-xs sm:text-sm lg:text-base bg-white w-[45%] sm:w-[25%] lg:w-[18%] sm:px-[1%] py-2 h-10 sm:h-[60px] rounded hover:bg-black hover:text-white transition duration-500 ease-in-out ">Find Agent</button>
      </Link>
      <div className="absolute top-0 right-0 w-12 md:w-24 lg:w-32 h-7 md:h-12 lg:h-16">
        <Image
      ...
      <div className="absolute top-0 right-0 w-5 md:w-12 lg:w-16 h-12 md:h-20 lg:h-28">
        <Image
