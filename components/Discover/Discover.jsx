...
const Discover = () => {
    ...
    return (
        <div className='mt-44 flex flex-col sm:flex-row' id="discover">
            <div className='flex flex-col mt-12 sm:mt-8 ml-[5%] mr-[5%] sm:mr-16 text-center sm:text-left '>
            ...
            <div className='order-first sm:order-none ml-[3%] sm:ml-0 mt-14 gap-3 lg:gap-6 sm:w-[60%] flex sm:grid grid-flow-col auto-cols-max'>
