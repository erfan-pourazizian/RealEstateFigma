  ...
  return (
    <div className='mx-[5%] mt-28' id='ourservices'>
      ...
      <div className='flex flex-col sm:flex-row mt-10 sm:mt-36'>
        <div className="bg-sp-gray3 relative mx-auto sm:mx-0 sm:absolute sm:w-3/4 py-2 sm:py-7 md:py-10 lg:py-24 xl:py-28 2xl:py-[150px] sm:mt-3 rounded-b sm:rounded px-3 sm:px-7 md:px-9 lg:px-14 xl:px-16 2xl:px-24 pb-3 sm:pb-0">
          ...
          <p className='text-center sm:text-left text-sm sm:text-xs md:text-base xl:text-spSize2 text-sp-gray2 my-4 sm:my-2 lg:my-3 xl:my-4 2xl:my-5'>{houseOptions.mainParagraph}</p>
          <p className='text-center sm:text-left text-sp-gray2 text-sm sm:text-xs md:text-sm sm:w-[49%]'>{houseOptions.paragraph}</p>
          <Link href={houseOptions.buttonLink}>
            <button className="font-semibold flex mx-auto sm:mx-0 text-xs lg:text-sm 2xl:text-base bg-sp-orange px-5 md:px-6 mt-5 py-1 h-9 md:h-[45px] rounded-t-sm sm:rounded-sm text-white sm:mr-auto cursor-pointer
